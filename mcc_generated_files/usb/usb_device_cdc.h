...
See the License for the specific language governing peParirmissions and
...
#else
//    #define LINE_CODING_TARGET NULL
 ...
 *****************************************************************************/
#define CDCSetBaudRate(id, baudRate) {UART_GetLineCodingById(id)->dwDTERate=baudRate;}
 ...
 *****************************************************************************/
#define CDCSetCharacterFormat(id, charFormat) {UART_GetLineCodingById(id)->bCharFormat=charFormat;}
 ...
 *****************************************************************************/
#define CDCSetParity(id, parityType) {UART_GetLineCodingById(id)->bParityType=parityType;}
 ...
 *****************************************************************************/
#define CDCSetDataSize(id, dataBits) {UART_GetLineCodingById(id)->bDataBits=dataBits;}
 ...
 *****************************************************************************/
#define CDCSetLineCoding(id, baud,format,parity,dataSize) {\
            CDCSetBaudRate(id, baud);\
            CDCSetCharacterFormat(id, format);\
            CDCSetParity(id, parity);\
            CDCSetDataSize(id, dataSize);\
        }
 ...
 *****************************************************************************/
#define USBUSARTIsTxTrfReady(id)      (cdc_trf_state[id] == CDC_TX_READY)
 ...
 *****************************************************************************/
#define mUSBUSARTIsTxTrfReady(id)     USBUSARTIsTxTrfReady(id)
 ...
 *****************************************************************************/
#define mUSBUSARTTxRam(id, pData,len)   \
{                                   \
    pCDCSrc[id].bRam = pData;           \
    cdc_tx_len[id] = len;               \
    cdc_mem_type[id] = USB_EP0_RAM;     \
    cdc_trf_state[id] = CDC_TX_BUSY;    \
}
 ...
 *****************************************************************************/
#define mUSBUSARTTxRom(id,pData,len)   \
{                                   \
    pCDCSrc[id].bRom = pData;           \
    cdc_tx_len[id] = len;               \
    cdc_mem_type[id] = USB_EP0_ROM;     \
    cdc_trf_state[id] = CDC_TX_BUSY;    \
}
...
/**********************************************************************************
  ...
  Conditions:
    ...
    bigger or equal to the size specified by 'len'.
  Input:
    id -      CDC index/id, 0 to 3 inclusive
