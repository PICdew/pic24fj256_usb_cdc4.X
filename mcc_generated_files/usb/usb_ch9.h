...
#define USB_DESCRIPTOR_DEBUG            0x0A    // bDescriptorType for an Debug Descriptor.
#define USB_DESCRIPTOR_IAD              0x0B    // bDescriptorType for an Interface Association Descriptor.
