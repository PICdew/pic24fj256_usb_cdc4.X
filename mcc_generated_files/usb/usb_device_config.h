...
#define USB_MAX_NUM_INT     	8   //Set this number to match the maximum interface number used in the descriptors for this firmware project
#define USB_MAX_EP_NUMBER	    8   //Set this number to match the maximum endpoint number used in the descriptors for this firmware project
...
/* CDC */
#define CDC_MAX_COUNT           4
#define CDC_COMM_INTF_ID(n)     (n << 1)
#define CDC_COMM_EP(n)          ((n << 1) + 0x01)
#define CDC_COMM_IN_EP_SIZE     10

#define CDC_DATA_INTF_ID(n)     ((n << 1) + 0x01)
#define CDC_DATA_EP(n)          ((n << 1) + 0x02)
/* For full speed, bulk transfer type, supported size are 8, 16, 32 and 64 bytes */
...
#define USB_CDC_SET_LINE_CODING_HANDLER     APP_DeviceCDCSetLineCoding
